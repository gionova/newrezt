...
router.get('/nhentai1', async(req, res, next) => {
  const apikey = req.query.apikey;
  const wann = [ '316755', '316596', '311850', '315578', '315488', '315406', '315344', '315323', '315136', '315099 ','316867', '316869', '316785', '316445', '316250', '311283', '265671', '312127', '311560', '316820', '316481', '316430', '276347', '196329', '304543', '295295', '311262', '311882', '312180', '271890', '272057', '272173', '272182', '272196', '272197', '272259', '272276', '272290', '272377', '272390', '272512', '271245', '271056', '270809', '269653', '266088', '264980', '262215', '260433', '260146', '256738', '272425', '272352', '272045', '272015', '271993', '271924', '271905', '271797', '271760', '271717', '271726', '271667', '267352', '152968', '238876', '116395', '84809', '211656', '272117', '188721', '266402', '238876']
   const wan = wann[Math.floor(Math.random() * (wann.length))]
  if(!apikey) return res.json(loghandler.notparam)
...
router.get("/maker/nulis", async (req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
    let hasil = 'https://zeks.me/api/nulis?text=${text}&apikey=apivinz' 
    data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/matrix', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/matrix?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/breakwall', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/breakwall?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/flowertext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/flowertext?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/smoketext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/smoketext?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/skytext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/skytext?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/pubglogo', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/pubglogo?text1=${text1}&text2=${text2}&apikey=administrator'
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/bneon', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/bneon?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/naruto', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/naruto?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/teks3d', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/text3dbox?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/nulis', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/nulis?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/epep', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/epep?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/silverbutton', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/splaybutton?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/goldbutton', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://zeks.me/api/gplaybutton?text=${text}&apikey=administrator' 
  data = await fetch(hasil).then(v => v.buffer())
